...
#         if doc['title_translated'] and doc['maintext_translated']:
#             sents = nltk.sent_tokenize(cut_dateline(doc['maintext_translated']))
#             try:
#                 if sents[0] and sents[1]:
#                     return doc['title_translated'] + '. ' + sents[0] + sents[1]# TODO: multilingual tokenizer needed
#             except:
#                 try:
#                     if sents[0]:
#                         return doc['title_translated'] + '. ' + sents[0]
#                 except:
#                     return doc['title_translated']
        # elif doc['title_translated'] and doc['description']:
...
def build_combined(doc):
    ...
    try:
        try:
            if doc['title_translated'] and doc['maintext_translated']:
                return doc['title_translated'] + '. ' + nltk.sent_tokenize(cut_dateline(doc['maintext_translated']))[0]  + nltk.sent_tokenize(cut_dateline(doc['maintext_translated']))[1] # TODO: multilingual tokenizer needed
        except:
            if doc['title_translated'] and doc['maintext_translated']:
                return doc['title_translated'] + '. ' + nltk.sent_tokenize(cut_dateline(doc['maintext_translated']))[0]   # TODO: multilingual tokenizer needed
